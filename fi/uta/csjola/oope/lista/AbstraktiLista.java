...
/**
  ...
  * Informaatiotieteiden yksikkä, Tampereen yliopisto.
  */
...
public abstract class AbstraktiLista implements Lista {
   ...
   /** Listan alkioiden lukumäärä. Vain jälkeläisten käyttään. */
   protected int koko;
   ...
   /** Tarkistetaan onko paikka kunnollinen. Vain jälkeläisten käyttään.
     *
